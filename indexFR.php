    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="ml-auto navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#Team">Notre &eacute;quipe</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="LogboekFR.html">Journal de bord</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="indexFR.php">FR</a>
                        <a class="dropdown-item" href="indexEN.php">ENG</a>
                    </div>
                </li>
                <!--
                <!--
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Bienvenue sur notre site Internet!</h1>
          <p>
            Nous sommes des étudiants de dernière année 6ITN du Collège Oscar Romero. 
            Pour notre GIP, nous avons choisi de faire un programme pour Garage Mertens, 
            situé à Termonde, que nous avons appelé «Automative Checker». 
            Ce nom fait référence directement à la raison de notre projet: l'automatisation du système de contrôle. 
            Bart est le fils du gérant de Garage Mertens, ce qui explique tout de suite notre lien avec l'entreprise.
          </p>
          <br>
        </div>
